...
export type PickAction<A extends Action<string>, T extends A['type']> = Extract<
    A,
    { type: T }
>;
...
export interface ResponseSuccessAction<
    ActionT extends string = string,
    ResponseT = undefined,
> extends Action<ActionT> {
...
export interface ResponseFailedAction<
    ActionT extends string = string,
    ResponseT = undefined,
> extends Action<ActionT> {
...
export type AsyncRetT<T> = T extends (...args: unknown[]) => Promise<infer R>
    ? R
    : never;
