...
export const getRooms = (): PickAction<
    RoomsAction,
...
export const getCurrentRoomSuccess = (
    payload: AxiosResponse<GameRoom>,
): PickAction<RoomsAction, RoomsActionType.getCurrentRoomSuccess> => ({
...
export const createRoomSuccess = (
    payload: AxiosResponse<GameRoom>,
): PickAction<RoomsAction, RoomsActionType.createRoomRequestSuccess> => ({
...
export const joinRoomSuccess = (
    payload: AxiosResponse<GameRoom>,
): PickAction<RoomsAction, RoomsActionType.joinRoomSuccess> => ({
...
export const joinRoom = (
    roomId: string,
): PickAction<RoomsAction, RoomsActionType.joinRoom> => ({
...
): PickAction<RoomsAction, RoomsActionType.updateRoomSettings> => ({
    type: RoomsActionType.updateRoomSettings,
    options,
});

export const saveGameOptions = (): PickAction<
    RoomsAction,
    RoomsActionType.saveRoomSettings
> => ({
